...
describe("Test utils", () => {
    ...
    describe("Test number utils", () => {
        ...
        describe("Test germanDecimalNumberToFloat", () => {
...
// check if object is expected raw transactions object
// check if object is expected parsed transactions object
// check if object is expected report object